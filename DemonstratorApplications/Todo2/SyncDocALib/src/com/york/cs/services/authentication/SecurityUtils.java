...
/**
 * The SecurityUtils class contains methods used for password
...
public final class SecurityUtils {
	 ...
	 * Seed to encryption.
	 */
	private static final String SEED = "com.cs.york";

	/**
	 * This method appends a byte to a string buffer with hex format.
	 * 
	 * @param sb
	 *            String buffer to append in
	 * @param b
	 *            Byte to append to the buffer
	 */
	private static void appendHex(StringBuffer sb, byte b) {
		sb.append(SecurityUtils.HEX.charAt((b >> 4) & 0x0f)).append(
				SecurityUtils.HEX.charAt(b & 0x0f));
	}

	/**
	 * This method gets a raw key from the given seed. Raw key is needed for
	 * encrypt/decrypt text
	 * 
	 * @param seed
	 *            Seed used to get the raw key
	...
	/**
	 * This method encrypts text with the given raw byte array. The algorithm
	 * used is AES
	 * 
	 * @param raw
	 * @param clear
	 *            Byte representation of text to encrypt
	...
	public static String base64Decode(String base64) {
		return SecurityUtils.toHexadecimal(Base64
	 ...
	 * 
	 * @param hexString
	 *            String in hex format to convert
	 ...
	 * 
	 * @param buf
	 *            Byte array to get its hex representation
