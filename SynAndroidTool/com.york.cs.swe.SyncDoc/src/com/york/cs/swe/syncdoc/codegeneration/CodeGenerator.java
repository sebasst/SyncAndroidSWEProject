package com.york.cs.swe.syncdoc.codegeneration;
...
public class CodeGenerator {
	...
	public static void main(String[] args) throws Exception {
		...
		if (args.length != 1) {
			System.out.println("Use: Generator foo.emf or Generator foo.ecore");
			return;
		}
		
		CodeGenerator pg = new CodeGenerator(true);
	...
	public CodeGenerator(boolean generatePluginXml) {
	...
	protected void generate(EmfModel model, File directory) throws Exception {
		...
		module.parse(CodeGenerator.class.getResource("coordinator.egx").toURI());
